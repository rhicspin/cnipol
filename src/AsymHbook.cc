...
void HHBOOK1(int hid, const char* hname, int xnbin, float xmin, float xmax)
{
    hhbook1d_(&hid, (char*) hname, &xnbin, &xmin, &xmax, strlen(hname));
    return;
}
...
void HHFITHN(int hid, char*chfun, char*chopt, int np, float*par,
