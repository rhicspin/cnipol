...
The name of the script to execute is `run_asym_daemon.sh`. However, the first line in the script should to be changed to the location of the setup.sh and the run number. 
