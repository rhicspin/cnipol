/** Generated TOC
    ...
    06 May 2010 - Dmitri Smirnov <dmitri.smirnov@plexoos.com> 
...
generated_toc = {
  ...
  generate: function() {
    ...
    for (var i=0; i<headings.length; i++) {
       ...
       if (divSection) {
          ...
          //alert("toggle gCookieValue: " + toggle);
          //ddss: divSection.style.display = toggle ? 'block' : 'none';
    ...
    for (var i=0; i<headings.length; i++) {
      ...
      while(this_head_lvl > cur_head_lvl) {
        ...
        //alert(prev_head_el.tagName);
        //alert("olstatus gCookieValue: " + olstatus);

        //ddss: new_list_el.style.display = olstatus ? "block" : "none";
      ...
      //if (headings[i].nodeName.toLowerCase() == "h1") li.className += " bold";
      //if (cur_head_lvl == "h1") li.className = "count bold";
      //else li.className = "count";
      ...
      //ddss: li.appendChild(document.createTextNode(' '));
      //ddss: li.appendChild(a);

      cur_list_el.appendChild(li);

      //ddss: headings[i].appendChild(document.createTextNode(' '));
    ...
    //alert(tocparent.textContent);
    //alert(tocparent.toHTML());
    //alert(tocparent.toString);
    //alert(tocparent.toSource());
    //alert(tocparent.innerHTML());
    ...
    //document.write(tocparent.toSource());
  },
  ...
  wrapOpenCloseDiv2: function(a, a2, headingIndex, headings, lists, sections) {
    ...
    return function(e) {
      ...
      //  generated_toc.createCookie(cur_list_el.id,"block",21);
      //} else {
      //  generated_toc.createCookie(cur_list_el.id,"none",21);
      //}
      ...
      for (var i=0; i<lists.length; i++) {
        ...
        if (lists[i].id == "ol:"+headings[headingIndex].id) {
           ...
           if (ds == "block") {
             //generated_toc.createCookie(heading.id, "block", 21);
             generated_toc.setHeadingCookie(headingIndex, "1");
           } else {
             //generated_toc.createCookie(heading.id, "none", 21);
      ...
      for (var i=0; i<sections.length; i++) {
        //if (sections[i].id == "div:" + heading.id) {
  ...
  createCookie2: function(value, days)
  {
    ...
    //document.cookie = "sections="+value+expires+"; path=/";
  ...
  getSection: function(sectionNum) {
     //generated_toc.readCookie2().charAt(sectionNum) * 1;
  },
...
function resetToc() {
   ...
   for (var i=0; i<headings.length; i++) {
      ...
      //var list = document.getElementById("ol:" + headings[i].id);
      //var divSection = document.getElementById("div:" + headings[i].id);

      //if (headings[i].nodeName.toLowerCase() == "h1")// ||
      //    //headings[i].nodeName.toLowerCase() == "h2")
      //{
