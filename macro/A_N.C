...
public:
   ...
   void  Plot(Int_t mode, Int_t ndata);
   void  ControlCenter(TCanvas *CurC, TPostScript *ps, Char_t *Energy);
};
...
Int_t A_N::GetData(Char_t * DATAFILE)
{
   ifstream fin;
...
void A_N::Plot(Int_t Mode, Int_t ndata)
{
   Int_t Color=2;
...
void A_N::ControlCenter(TCanvas *CurC, TPostScript *ps, Char_t * Energy)
{
   // frame dimensions
   Float_t xmin = 0.;
   Float_t xmax = 1200.;
