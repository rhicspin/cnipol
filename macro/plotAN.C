...
{ //{{{
   ...
   TLegend* leg2 = new TLegend(0.7, 0.75, 0.95, 0.9);
   ...
   f_AN(cal_t, cal_AN, rho, sigma, 0, 0, fac); // write 256 points
...
{ //{{{
   ...
   for (i = 0; i < 256; ++i) {
      ...
      double ans = xx * ((myuP - 1) * (1 - delta * rho) - 2 * (Imr5 - delta * Rer5)) - 2 * (Rer5 - rho * Imr5);
