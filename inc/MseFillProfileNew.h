...
sql_create_12(MseFillProfileNew, 3, 0,
   ...
   mysqlpp::sql_float,        prof_r0,
   mysqlpp::sql_float,        prof_r0_err,
   mysqlpp::sql_float,        prof_rslope,
   mysqlpp::sql_float,        prof_rslope_err,
